# -*- coding: utf-8 -*-
"""
Created on Fri May 20 09:46:06 2022
...
class Keithley2502_Src_2(VisaInstrument):
    """
    ...
    def set_volt(self, v_start, v_stop):
        ...
        if len(v_vals) < 2:
            v_vals = [v_start, v_stop]
        for self._VALUE in v_vals[1:]:
            if self._STOP:
                self._STOP = False
                break
            self.volt(self._VALUE)
            print(self._VALUE)
